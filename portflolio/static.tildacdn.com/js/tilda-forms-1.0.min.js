...
function t_forms__calculateFieldsWidthInJS(t, e) {
    ...
    for (var a in o)
        if (t.classList.contains(o[a])) {
            ...
            n && n.classList.contains("t-input-title") && (n.style.width = (e - r * (a - 1)) / a + "px"), window.innerWidth < 480 && (t && (t.style.width = "100%"), n && (n.style.width = "100%"))
        }
}
...
function t_forms__onSuccess(t) {
    ...
    var e = t.closest(".r"),
        ...
        c = t.querySelector(".t-form__successbox"),
        u = c ? c.getBoundingClientRect().top + window.pageYOffset : 0,
        m = 0,
    ...
    if (u > window.scrollY || w - d < p - 100) o.classList.add(h), p > w && b && setTimeout((function() {
        t_fadeOut(b)
    }), 300);
    else {
...
function t_forms__scrollBeginForm(t) {
    ...
    function s() {
        a += n, window.scrollTo(0, i(a)), a < e ? setTimeout(s, n) : document.body.removeAttribute("data-scrollable")
    }
...
window.t_forms__lang = (window.navigator.userLanguage || window.navigator.language).toUpperCase().slice(0, 2), window.scriptSysPayment = {}, window.handlerSysPayment = {}, window.isInitEventsZB = {}, window.isInitEventsCustomMask = {}, window.initForms = {}, window.tildaForm = {
        ...
        for (var e = t.querySelectorAll(".js-tilda-rule"), r = [], o = !0, a = 0; a < e.length; a++) {
            ...
            if (!(i && "true" === i.getAttribute("data-hidden-by-condition") || s && "true" === s.getAttribute("data-hidden-by-condition"))) {
                ...
                _.obj = n, _.type = [], w && w.length && (y = w.replace(/[\s\u0000—\u001F\u2000-\u200F\uFEFF\u2028-\u202F\u205F-\u206F]/gi, ""), w = w.trim()), p && (p = parseInt(p, 10)), f && (f = parseInt(f, 10));
                var b = !w.length && !y.length,
                    E = "checkbox" === h || "radio" === h,
                    x = t.querySelectorAll('[name="' + g + '"]:checked').length;
                if ((w.length && !E || E && x) && (o = !1), d && (b || E && !x)) _.type.push("req");
                else {
                    switch (c) {
                        case "email":
        ...
        if ("y" === v) {
            ...
            if (L && window.tcart.total < window.tcart_mincntorder)(_ = {
                obj: {},
                type: []
                ...
                for (var u = 0; u < e[c].type.length; u++) {
                    ...
                    if (l = "", (i = t.querySelectorAll(".js-rule-error-" + _)).length)
                        for (var y = 0; y < i.length; y++) {
                            var h;
                            (h = i[y]).getAttribute("data-rule-filled") ? h.style.display = "block" : (h.textContent && h.innerText || !t_forms__getMsg(_) ? l = i[0].textContent || i[0].innerText : h.innerHTML = '<a href="#" class="t-form__errorbox-link">' + t_forms__getMsg(_) + "</a>", h.style.display = "block", -1 === d.indexOf(_) && t_forms__moveToErrorInput(w, h), d.push(_))
                        } else if (t_forms__getMsg(_) && (i = t.querySelectorAll(".js-rule-error-all")).length)
                            for (var y = 0; y < i.length; y++) {
                                var h;
                                (h = i[y]).innerHTML = '<a href="#" class="t-form__errorbox-link">' + t_forms__getMsg(_) + "</a>", h.style.display = "block", -1 === d.indexOf(_) && t_forms__moveToErrorInput(w, h), d.push(_)
                            }
        ...
        if (t) {
            ...
            try {
                ...
                if (e && t_removeEl(e), !window.mauser) return;
    ...
    for (var e = [], r = t.querySelectorAll("input, textarea, button, select"), o = 0; o < r.length; o++) {
        ...
        if (!(!r[o].name || r[o].disabled || ["file", "reset", "submit", "button"].indexOf(r[o].type) > -1 || a && a.getAttribute("data-hidden-by-condition")))
            if ("select-multiple" !== r[o].type)["checkbox", "radio"].indexOf(r[o].type) > -1 && !r[o].checked || e.push({
                ...
                for (var n = r[o].options, i = 0; i < n.length; i++) n[i].selected && e.push({
                    name: n[i].name,
                    value: n[i].value
                })
    }
