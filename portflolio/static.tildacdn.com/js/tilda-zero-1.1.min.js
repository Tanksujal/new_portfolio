function t396_init(e) {
    ...
    d && (t396_initTNobj(e, d), t396__initOnlyScalable(), r = t396_detectResolution(e), i = document.getElementById("allrecords"), t396_switchResolution(e, r), t = "window" === t396_ab__getFieldValue(d, "upscale"), t396__setGlobalScaleVariables(e, r, t), t396_updateTNobj(e), t396_artboard_build("", e), n = "ontouchend" in document, window.addEventListener("resize", function() {
        d.classList.add("t396_resizechange"), t396_waitForFinalEvent(function() {
            window.t396__isMobile || n ? document.documentElement.clientWidth !== window.tn_window_width && a && t396_isBlockVisible(a) && (t396_doResize(e), d.classList.remove("t396_resizechange")) : a && t396_isBlockVisible(a) && (t396_doResize(e), d.classList.remove("t396_resizechange"))
    ...
    }), window.tildaMembers && "MutationObserver" in window && (o = new MutationObserver(function(t) {
        t.forEach(function(t) {
            "attributes" === t.type && "class" === t.attributeName && t.target.classList.contains("tlk-courses_page") && (t396_doResize(e), o.disconnect())
        })
    ...
    }, 1e3), r = !!document.querySelector(".t635__textholder"), a && r && l && d && l.addEventListener("animationInited", function() {
        t396_allelems__renderView(d), t396_allgroups__renderView(d), t396_doResize(e)
    }), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) && l && l.classList.add("t396_safari"), r = i ? "edit" === i.getAttribute("data-tilda-mode") : null, t && !r && t_onFuncLoad("t396_scaleBlock", function() {
        t396_scaleBlock(e)
...
function t396__initOnlyScalable() {
    var t, e, i;
    void 0 === window.isOnlyScalable && (e = (t = window.navigator.userAgent.match(/Firefox\/([0-9]+)\./)) ? parseInt(t[1], 10) : 126, i = (i = window.navigator.userAgent.match(/Chrome\/([0-9]+)\./)) && parseInt(i[1], 10) || 0, window.isOnlyScalable = e < 126, window.shouldUseScaleFactor = !window.isOnlyScalable && !t && i <= 127)
}

function t396__setGlobalScaleVariables(t, e, i) {
    window.tn_window_width = document.documentElement.clientWidth;
    t = "ab" + t;
    i ? (window.tn[t].scaleFactor = parseFloat((window.tn_window_width / e).toFixed(3)), window.tn_scale_factor = parseFloat((window.tn_window_width / e).toFixed(3))) : (window.tn[t].scaleFactor = 1, window.tn_scale_factor = 1)
}
...
function t396_doResize(t) {
    var e = t396_isOnlyScalableBrowser(),
        ...
        a = (t396__setScaleFactorForElements(t), t396_removeElementFromDOM(r), e ? (r = i ? i.querySelectorAll(".tn-molecule, .tn-atom") : [], Array.prototype.forEach.call(r, function(t) {
            var e, i;
        ...
        })), t396_switchResolution(t, o), i ? i.querySelector(".t396__artboard") : null),
        r = "window" === t396_ab__getFieldValue(a, "upscale"),
        e = (t396__setGlobalScaleVariables(t, o, r), t396_updateTNobj(t), t396_ab__renderView(a), n ? n.getAttribute("data-tilda-mode") : "");
    r && "edit" !== e && t_onFuncLoad("t396_scaleBlock", function() {
        t396_scaleBlock(t)
    ...
    }), t396__processAbsoluteArtBoard(a), t396__processTopShift(a, t, !0), t396_allelems__renderView(a), t396_allgroups__renderView(a), a && [a, a.querySelector(".t396__carrier"), a.querySelector(".t396__filter")].forEach(function(t) {
        t && (t.style.height = "")
    })
}
...
function t396__setScaleFactorForElements(t) {
    var e, i = document.getElementById("rec" + t),
        i = i ? i.querySelector(".t396__artboard") : null;
    i && (e = t396__getCurrentScaleFactor(t), t = i.querySelectorAll(".t396__elem, .tn-group"), Array.prototype.forEach.call(t, function(t) {
        t.scaleFactor = e
    }))
}
        ...
        switch (e) {
            case "left":
                ...
                if ("%" === t396_elem__getFieldValue(t, "leftunits") && (i = t396_roundFloat(y * i / 100)), m) {
                    ...
                    break
                }!d && l ? "grid" === g && _ && (i *= h) : i = b + i, "center" === w && (x = t396_elem__getWidth(t), s && "window" !== f && (y *= h, x *= h), i = y / 2 - x / 2 + i), "right" === w && (x = t396_elem__getWidth(t), s && "window" !== f && (y *= h, x *= h), i = y - x + i), s && "window" !== f && (i += ((x = t396_elem__getWidth(t)) * h - x) / 2);
                break;
            case "top":
                function v(t) {
                ...
                if (f = "grid" === g ? "grid" : "window", b = "grid" === g ? parseFloat(b) : 0, y = "grid" === g ? parseFloat(y) : parseFloat(x), "%" === t396_elem__getFieldValue(t, "topunits") && (i = y * (i / 100)), m) {
                ...
                l && !d && x && (A = parseInt(b, 10) * h), "center" === c && (V = v(t), s && "window" !== f && ("stretch" !== a ? y *= h : y = A ? S < A ? A : S : F.clientHeight, V *= h), d || !l || _ || "window" === f || "stretch" !== a || (y = A ? S < A ? A : S : F.clientHeight, y /= h), i = y / 2 - V / 2 + i), "bottom" === c && (V = v(t), s && "window" !== f && ("stretch" !== a ? y *= h : y = A ? S < A ? A : S : F.clientHeight, V *= h), d || !l || _ || "window" === f || "stretch" !== a || (y = A ? S < A ? A : S : F.clientHeight, y /= h), i = y - V + i), s && "window" !== f && (x = ((V = v(t)) * h - V) / 2, i += x = Math.round(x))
        }
        return i
    }
}
...
function t396_allgroups__renderViewAutolayout(t) {
    var e, i;
    t && t.classList.contains("t396__group-flex") && (e = t396_group__getFieldValue(t, "widthmode"), i = t396_group__getFieldValue(t, "heightmode"), t.style.width = "hug" === e ? "min-content" : "", t.style.height = "hug" === i ? "initial" : "")
}
