...
function t_zeroForms__renderForm(t, e, r, o) {
    ...
    if ((i || (i = "published" !== o), !t.classList.contains("zero-form-rendered") || i) && ("published" === o && t396_zeroForms__setBrowsersInfo(), !t_zeroForms__isRecordHidden(t.closest(".r")) && !t_zeroForms__isFormOutside(t) || "published" !== o)) {
        ...
        var l = t_zeroForms__fromObjToArray(e),
            c = t.querySelector(".tn-atom");
        if ("zero" === o || "edit" === o) c.innerHTML = "";
        else if (c.querySelector(".t-form")) return;
        var _ = t_zeroForms__createForm(r, o, l, t);
        if (_) {
            c.insertAdjacentElement("beforeend", _), t_zeroForms__placeFormIntoColumns(t);
...
function t_zeroForms__createForm(t, e, r, o) {
    ...
    _.classList.add("js-successbox"), _.classList.add("t-form__successbox"), _.classList.add("t-text"), _.classList.add("t-text_sm"), _.style.display = "none", _.innerHTML = n.formmsgsuccess, s.insertAdjacentElement("beforeend", _);
    var d = {
    ...
    if (p) {
        ...
        b.style.textAlign = "center" === n.buttonalign ? "center" : "left", b.style.color = d.color, b.style.fontWeight = d.fontWeight, b.style.fontFamily = d.fontFamily, b.style.marginTop = "15px", b.style.fontSize = "13px";
        var g = t_zeroForms__getBottomText(m, n, t, o, p);
        b.appendChild(g), s.insertAdjacentElement("beforeend", b)
    }
    if (s.insertAdjacentElement("beforeend", t_zeroForms__createErrorBox(n, "bottom")), s.insertAdjacentElement("beforeend", t_zeroForms__createCommentField()), t_zeroForms__createInputPlaceholderStyles(m, n, t, o), "h" === n.inputpos || "zero" === e) {
        var v = "t-zero-form-h-styles";
        t_zeroForms__setScriptOrStyle(v, "tilda-zero-form-horizontal.min.css", "", "link", !1);
    ...
    if (n.fieldfontfamily) {
        var h = t_zeroForms__createSelector(t, m, ""),
            z = ['input[type="text"]', 'input[type="tel"]', ".t-input-phonemask__select", "textarea", "select", ".t-input__vis-ph"],
            w;
        t_zeroForms__setScriptOrStyle(y, "", (z = z.reduce((function(t, e, r) {
            return t += h + ".t-input-block " + e, r !== z.length - 1 && (t += ", "), t
    ...
    return window.addEventListener(S, (function() {
        L || (L = setTimeout((function() {
            t_zeroForms__updateCurrentResolution(t, A), t_zeroForms__updateStylesOnResize(t, o), clearTimeout(L), L = 0
        }), 600))
    })), s
}
...
function t_zeroForms__updateStylesOnResize(t, e) {
    ...
    var s = t_zeroForms__initInputStyles(r, i),
        l = e.querySelectorAll(".t-input-inline-styles:not(.t-input__own-answer)");
    ...
    var c = {
        ...
        d = e.querySelectorAll(".t-input-title");
    Array.prototype.forEach.call(d, (function(t) {
        t_zeroForms__setTitleStyles(t, c, _)
    }));
    var u = Array.prototype.slice.call(e.querySelectorAll(".t-input-group"));
    Array.prototype.forEach.call(u, (function(t) {
        t_zeroForms__setStylesForFormGroup(r, t)
    }));
    var m = e.querySelector(".t-submit");
    if (m) {
        t_zeroForms__setBtnInlineStyles(r, m), t_zeroForms__generateBtnStyles(m, t, o, r, e);
        var p = m.closest(".tn-form__submit");
        p && (p.style.textAlign = r.buttonalign, p.style.marginTop = r.buttonmargtop + "px", t_zeroForms__updateTopPosition(e))
    }
}
...
function t_zeroForms__parseIntoElement(t, e, r, o, n, i) {
    ...
    var l = "variation" === o.inputfontweight ? o.inputvariationweight : o.inputfontweight,
        c = "variation" === o.inputelsfontweight ? o.inputelsvariationweight : o.inputelsfontweight,
        _ = "variation" === o.inputtitlefontweight ? o.inputtitlevariationweight : o.inputtitlefontweight;
    r.li_title && t_zeroForms__generateTitle(r, n, s, _), r.li_subtitle && t_zeroForms__generateSubtitle(r, n, s);
    ...
    switch (p.classList.add("t-input-block"), r.li_type) {
        ...
        case "ws":
            ...
            var S = 34;
            r.li_rows && (f.style.height = r.li_rows * S + "px");
            break;
        case "fr":
            if (f = t_zeroForms__createCalculation(r, d, m, n), o.inputfrbgcolor) {
                var A = document.createElement("style"),
                    L = t_zeroForms__createSelector(t, i, ".t-input-group_fr");
                A.textContent = L + "{background-color:" + o.inputfrbgcolor + "; padding: 20px 30px 25px;}", f.insertAdjacentElement("beforeend", A)
            }
            t_zeroForms__onRender(e, !1, (function() {
...
function t_zeroForms__createInput(t, e, r, o) {
    var n = document.createElement("textarea" === o ? "textarea" : "input"),
        i, a, s;
    (t.li_title || t.li_subtitle ? n.id = t.li_type + "-" + t.lid : n.ariaLabel = o, t_zeroForms__appendMainSettingToField(n, r, "textarea" === o ? "" : "text", ""), ["name", "time", "url", "email"].some((function(t) {
        return t === o
...
function t_zeroForms__createSelect(t, e, r, o) {
    ...
    if (s.id = t.li_type + "-" + t.lid, t_zeroForms__appendMainSettingToField(s, r, "", "t-select"), r.secondaryClassName && s.classList.add("t-select_bbonly"), r.require && s.setAttribute("data-tilda-req", "1"), t_zeroForms__appendStylesToField(s, e), t.li_selfirstvar) {
        var l = document.createElement("option");
        l.textContent = t.li_selfirstvar, l.setAttribute("value", ""), s.insertAdjacentElement("beforeend", l)
    }
    var c = e && e.color && !o;
    return n.forEach((function(t, r) {
        var o = document.createElement("option");
        o.value = t, o.textContent = t, c && (o.style.color = e.color), i && i === r + 1 && (o.selected = !0), s.insertAdjacentElement("beforeend", o)
...
function t_zeroForms__createRadio(t, e, r, o, n, i, a) {
    ...
    var c = "cb" === t.li_radcb,
        ...
        u, m = t_zeroForms__createWrapper((c ? "t-checkboxes" : "t-radio") + "__wrapper");
    c && d.appendChild(t_zeroForms__createNameFieldForCheckbox(r, m, "checkboxes")), d.appendChild(m);
    ...
    return s.forEach((function(s, l) {
        ...
        m.type = n, m.value = s, m.classList.add("t-" + n), c || m.classList.add("js-tilda-rule"), c || (m.name = r.name);
        var b = t.li_title || t.li_subtitle;
        if (!c && b && (m.ariaLabel = b), _ && _ === l + 1) {
            m.checked = !0;
...
function t_zeroForms__createRadioImage(t, e, r) {
    ...
    if (n) {
        ...
        e.shouldUseTwoColumnRadioImg && l.classList.add("t-img-select__container__mobile_2-in-row"), l.setAttribute("data-check-bgcolor", e.inputelscolor || "#000"), o && s.appendChild(t_zeroForms__createNameFieldForCheckbox(r, l, "img-select")), s.appendChild(l);
        var c = o ? "checkbox" : "radio",
            _, d = "t-img-select__indicator_" + (t.li_imgratio ? t.li_imgratio.replace("_", "-") : "1-1");
        return i.forEach((function(n, i) {
            var s = t_zeroForms__createLabel("img-select", "", !1),
                _ = document.createElement("input");
            _.type = c, _.value = n.alt || n.img, _.classList.add("t-img-select"), o || (_.name = t.li_nm), o || _.classList.add("js-tilda-rule"), a && a === i + 1 && (_.checked = !0), r.require && _.setAttribute("data-tilda-req", "1"), s.insertAdjacentElement("beforeend", _);
            var u = t_zeroForms__createIndicator("img-select", !1, {
                ratio: d,
                img: n.img
            });
            if (u.classList.add("t-bgimg"), u.classList.add("t-img-select__indicator"), u.classList.add(d), u.setAttribute("data-original", n.img), u.style.backgroundImage = 'url("' + n.img + '")', s.insertAdjacentElement("beforeend", u), n.alt) {
...
function t_zeroForms__createUploadField(t, e, r) {
    ...
    if ("published" !== window.tildamode) {
        var n = "color:#fff;background-color:#000; padding:10px 20px; display:inline-block; margin-bottom:10px;",
    ...
    var s = o ? "t-upwidget" : "t-uploadcare",
        ...
        c = o ? "margin-bottom:5px;min-height:38px;" : "margin-bottom:10px;";
    l.setAttribute("style", c);
    var _ = document.createElement("input");
    t_zeroForms__appendMainSettingToField(_, e, "hidden", ""), _.setAttribute("role", o ? "upwidget-uploader" : "uploadcare-uploader"), e.require && _.setAttribute("data-tilda-req", "1"), _.style.display = "none", o ? (_.setAttribute("data-tilda-upwidget-key", t.li_uwkey || ""), "y" === t.li_multiupl && _.setAttribute("data-tilda-upwidget-multiple", "1")) : _.setAttribute("data-public-key", t.li_uckey || "demopublickey"), l.insertAdjacentElement("beforeend", _);
...
function t_zeroForms__createQuantityRange(t, e, r, o) {
    ...
    var l = t_zeroForms__createRangeField("min", r.inputtitlecolor, t.li_vmin || "0"),
        c = t_zeroForms__createRangeField("max", r.inputtitlecolor, t.li_vmax || "10");
    return s.insertAdjacentElement("beforeend", l), s.insertAdjacentElement("beforeend", c), n.insertAdjacentElement("beforeend", s), t_zeroForms__setScriptOrStyle("t-zero-range-script", "tilda-range-1.0.min.js", "", "script", !1), t_zeroForms__setScriptOrStyle("t-zero-range-styles", "tilda-range-1.0.min.css", "", "link", !1), n
}
...
function t_zeroForms__createCalculation(t, e, r, o) {
    ...
    if (t.li_prod_img) {
        var c = t_zeroForms__createHiddenField(t.li_prod_img, "prod_img", "t-calc__hidden__prod_img");
...
function t_zeroForms__generateBtnStyles(t, e, r, o, n) {
    var i, a = t_zeroForms__generateButtonStyles(o, window.getComputedStyle(t).fontFamily),
        ...
        c = document.getElementById("t-upwidget-zero-form"),
        _ = t_zeroForms__createSelector(e, r, ""),
        d = _ + ".t-submit",
        u = t_zeroForms__getGradientBGStyles(o, d);
    l && (d += ", ", d += _ + ".uploadcare--widget__button.uploadcare--widget__button_type_open"), c && (d += ", ", d += _ + ".t-upwidget-container__button");
    var m, p = d + "{" + a + (s ? "transition: 0.3s ease all;" : "") + "}";
    u && (p += u, t.classList.add("tn-form__submit-gradient"), l && (p += _ + ".uploadcare--widget__button.uploadcare--widget__button_type_open ", p += "{background-image: " + o.buttonbgcolor + "; background-color: transparent;}"), c && (p += _ + ".t-upwidget-container__button ", p += "{background-image: " + o.buttonbgcolor + "; background-color: transparent;}"));
...
function t_zeroForms__getBottomText(t, e, r, o, n) {
    ...
    if (["cb", "cbx"].some((function(t) {
        ...
        var _ = t_zeroForms__createIndicator("checkbox", e.inputelscolor, !1);
        _.style.width = "15px", _.style.height = "15px", _.style.marginRight = "5px", s.insertAdjacentElement("beforeend", _);
...
function t_zeroForms__animateInputs(t, e, r, o) {
    ...
    if (Array.prototype.slice.call(document.querySelectorAll(l)).forEach((function(t) {
        ...
        var _ = t.querySelectorAll("textarea:not(.t-input_bbonly)"),
...
function t_zeroForms__setScriptOrStyle(t, e, r, o, n) {
    if (!document.getElementById(t)) {
        var i = document.querySelector('script[src*="tilda-zero-forms"]'),
            a = i ? i.src : "",
            s = "https://static.tildacdn.com";
        a && -1 !== a.indexOf("https://") && (s = a.split("/js/")[0]);
        var l = document.createElement(o);
        r ? l.textContent = r : ("script" === o ? (l.src = s + "/js/" + e, l.async = !0, l.charset = "utf-8") : "link" === o && (l.href = s + "/css/" + e, l.rel = "stylesheet"), l.onerror = function() {
            t_zeroForms__onFuncLoad("t_fallback__reloadSRC", (function() {
                t_fallback__reloadSRC(l)
            }))
        }), l.id = t;
        var c = "style" === o && n ? n.querySelector(".tn-atom") : null,
            _;
        ("style" === o && c ? c : document.body).insertAdjacentElement("beforeend", l)
    }
}
...
function t_zeroForms__appendMainSettingToField(t, e, r, o) {
    r && "select" !== r && (t.type = r), t.name = e.name || "", o || t.classList.add("t-input"), o && ("object" == typeof o ? o.forEach((function(e) {
        t.classList.add(e)
...
function t_zeroForms__isFormOutside(t) {
    ...
    var n = o.getBoundingClientRect(),
        ...
        a = n.right + window.pageXOffset;
    if (i.right < 0 && a > 0) return !0;
    var s = !!o && o.getAttribute("data-artboard-ovrflw"),
        l;
    if ("auto" === s || "visible" === s) return !1;
    var c = t396_zeroForms__getScaleFactor(t),
        _ = t_zeroForms__setScaleFactor(i.left, c),
        d = t_zeroForms__setScaleFactor(parseInt(t.style.top, 10), c) || 0;
    d < 0 && d > -50 && (d = 0);
    var u = t.hasAttribute("data-animate-fix"),
        m = "scroll" === t.getAttribute("data-animate-prx"),
        p = d < 0 && !u && !m,
        f = n.height > 0 && d > n.height && !m;
    return p || f || _ > a
}
